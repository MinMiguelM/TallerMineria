...
public class TallerMineria {
    ...
    public static void main(String[] args) {
        try {
            ArffFile arff = ArffFile.construct( "ap1.arff" );
            
            arff.generalizacionMicroAgregacion(2,Arrays.asList(0, 1 , 9),new weka.core.EuclideanDistance(), 2, 10, 500, false, false);
            ...
            //arff.microAgregacion(new weka.core.EuclideanDistance(), 2, 10, 500, false, false, Arrays.asList(0,1,9));
